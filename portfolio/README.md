# Portfolio Jose Aurelio

Personal portfolio site for Jose Aurelio Porras, adapted as a first version from David Heckhoff's 2025 portfolio template.
...
- **Projects**: `src/content/projects/{en,de}/<slug>.ts` — copy, tags, media, links. The `de` folder is currently used for Spanish copy to minimize template churn.
...
The original project was created and designed by David Heckhoff.
